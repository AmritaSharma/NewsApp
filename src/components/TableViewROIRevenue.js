            ...
            <View style={styles(colors).searchBtnInputWrapper}>
              <View style={styles(colors).inputWrapper}>
                <TextInput
                  ...
                  maxLength={100}
                  IconName={'mail'}
                  onChangeText={text => setDepositId(text)}
                />
              </View>
        ...
        <FlatList
          ...
          renderItem={({item, index}) => (
            <View
              ...
              <Text style={styles(colors).bodyTextStyle}>{item.user_id}</Text>
              <Text style={styles(colors).bodyTextStyle}>{item.position}</Text>
              <Text style={styles(colors).bodyTextStyle}>
                {item.topup_amount}
              </Text>
            </View>
...
export default TableViewROIRevenue;
const styles = props =>
  StyleSheet.create({
    container: {
      flex: 1,
