...
const DirectPartnerListTableView = ({ data, parentCallback, }) => {
        ...
        <View style={styles(colors).container}>
            <View style={styles(colors).tableSearchViewWrapper}>
                <List.Accordion
                    ...
                    right={props => <Icon name={expanded ? "minus" : "plus"} size={20} color="#FFF" style={{ marginTop: -15, }} />}
                    expanded={expanded}
                    onPress={handlePress}
            ...
            <View style={styles(colors).showEntriesView}>
                ...
                <View style={styles(colors).showEntryDropWrapper}>
                    <SelectDropdown
                        ...
                        buttonTextStyle={{ color: 'white', fontSize: textSize.h6 }}
            ...
            <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'center', backgroundColor: '#262626', margin: 10, borderRadius: 5, marginBottom: 0 }}>
                <View style={styles(colors).previewView}>
                    <TouchableOpacity >
                        <Text style={styles(colors).buttonStyle}>{strings.Prev}</Text>
                    </TouchableOpacity>
                </View>
                <FlatList
                ...
                <View style={styles(colors).buttonView}>
                    <TouchableOpacity>
                        <Text style={styles(colors).buttonStyle}>{strings.Next}</Text>
                    </TouchableOpacity>
                </View>
            </View>
        </View>
...
export default DirectPartnerListTableView;
