        ...
        <ScrollView horizontal={true} vertical={true}>
          ...
          <View
            ...
            <View
              ...
              <Image
                style={[styles.smallImageStyle, {marginTop: 7}]}
            ...
            <View style={styles.RootViewStyle}>
              ...
              <View style={{alignItems: 'flex-end', width: getDimen(0.38)}}>
                ...
                <Text
                  style={{
                    marginTop: getDimen(-0.08),
                    marginLeft: 0,
                    fontSize: 10,
                    marginRight: getDimen(0.06),
                  }}>
                  roote
                </Text>
                <Image
